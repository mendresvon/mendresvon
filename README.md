...
# Von Breznev A. Mendres 馬盛中

**Computer Science student · STUST, Taiwan (Class of 2027) · Department Rank #1/132**
...
I'm a Filipino CS student at Southern Taiwan University of Science and Technology, currently working on transfer-learning research in multimodal emotion recognition alongside full-stack and applied-ML side projects. I care about building things that work end-to-end — from a trained model to a deployed API to a UI someone can actually click through.

## Featured Projects

| Project | What it is |
| :--- | :--- |
| 🧠 [**multimodal-causal-ablation**](https://github.com/mendresvon/multimodal-causal-ablation) | Neuron-level causal validation of modality competition in multimodal emotion recognition — contribution to a paper co-authored with faculty at NCKU, using linear probes and activation ablation on audio/text/video models. |
